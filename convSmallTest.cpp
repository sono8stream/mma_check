...
void mmaConvSmall()
{
    ...
    //     MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX_InitArgs initArgs;
    //     initArgs.funcStyle = MMALIB_FUNCTION_OPTIMIZED; // MMALIB_FUNCTION_NATC;
    //     initArgs.Ni = numInChannels;
    //     initArgs.No = numOutChannels;
    //     initArgs.Fr = kernelLength;
    //     initArgs.Fc = kernelLength;
    //     initArgs.shift = 0;
    //     initArgs.shiftMethod = MMALIB_CONVOLVE_COL_SHIFT_SINGLE;
    ...
    //     initArgs.bias = 0;
    //     initArgs.biasDataType = MMALIB_UINT8;
    //     initArgs.numBiasVals = numBiasVals;
    //     initArgs.activationType = MMALIB_RELU;
    //     initArgs.featureWidth = w;
    //     initArgs.blockFeatureHeight = h;
    //     initArgs.blockFeaturePitch = w;
    //     initArgs.columnOffset = (w + pad) * 2;
    //     initArgs.inPairOffset = w + pad;
